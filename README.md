...
## By
Prince Appiah & Nikhila Kukkala

## Overview

The goal of this project is to identify fraudulent or unusual transactions that deviate from normal behavior. The project involves data cleaning, feature engineering and selection, model training, evaluation, and visualization.
